...
create table if not exists `friend` (
    ...
    CONSTRAINT `fk_from_user_idx` FOREIGN KEY (from_user_idx) REFERENCES `user` (user_idx),
    CONSTRAINT `fk_to_user_idx` FOREIGN KEY (to_user_idx) REFERENCES `user` (user_idx)
 ); 
...
create table if not exists `perfectplay`(
    ...
    CONSTRAINT `fk_song_idx` FOREIGN KEY (song_idx) REFERENCES `song` (song_idx)
);
...
create table if not exists `chat` (
    ...
    user_idx int NOT NULL COMMENT '유저 인덱스',
    CONSTRAINT `fk_chatroom_idx` FOREIGN KEY (chatroom_idx) REFERENCES `chatroom` (chatroom_idx),
    CONSTRAINT `fk_user_idx` FOREIGN KEY (user_idx) REFERENCES `user` (user_idx)
);
...
create table if not exists `comment` (
   ...
   user_idx int NOT NULL COMMENT '유저 인덱스',
   CONSTRAINT `fk_board_idx` FOREIGN KEY (board_idx) REFERENCES `board` (board_idx),
   CONSTRAINT `fk_user_idx` FOREIGN KEY (user_idx) REFERENCES `user` (user_idx)
);
...
create table if not exists `channel_video` (
   ...
   user_idx int NOT NULL COMMENT '유저 인덱스',
   CONSTRAINT `fk_channel_idx` FOREIGN KEY (channel_idx) REFERENCES `channel` (channel_idx),
   CONSTRAINT `fk_video_idx` FOREIGN KEY (video_idx) REFERENCES `video` (video_idx),
   CONSTRAINT `fk_user_idx` FOREIGN KEY (user_idx) REFERENCES `user` (user_idx) -- 유저 인덱스가 왜 필여하지?
);
